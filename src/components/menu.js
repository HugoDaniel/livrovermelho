...
const Menu = ({ allSitePage, sectionMenu }) => {
  ...
  return (
    <div
      className="SectionsList db mt3 w-100 flex-wrap-l items-start-l justify-center-l flex-l"
      style={{ flexBasis: "33%" }}
    >
  ...
  return (
    <div className="ma2-ns link">
      <Img
        ...
        className=""
      />
      <div className="QuadradoTitulo flex flex-column justify-between bg-vermelho absolute br2 right-0 pa0 ma0 pr4 static-ns pa0-ns ma0-ns br0-ns ph2-ns pv1-ns h4-ns min-h-100-ns" style={{  }}>
